...
export default async function NavBar() {
  ...
  return (
    <>
    <nav  className="lg:flex items-center justify-center h-[12vh] max-h-[12vh] hidden rounded-full border border-gray-200 bg-white shadow-sm px-6 w-fit mx-auto mt-4">
